$(document).ready(function() {
    function createCheckoutProductCard(obj) {
        ...
        card.classList.add('checkoutCard');
        var firstInnerDiv = document.createElement('div');
        var productImg = document.createElement('img');
        productImg.classList.add('checkoutImg');
    ...
    for(var i=0; i<productList.length; i++) {
        $('#cardList').append(createCheckoutProductCard(productList[i]));
    ...
    var placeOrder = document.getElementById("btnplaceOrder");
